...
pub struct Pattern
{
	...
	pub template: Bitmap<64>,
}

impl Pattern
{
	fn new(dim: u32, template: Bitmap<64>) -> Self
	{
		Pattern {
			dim,
...
fn parse_piece_size(r: &mut Reader<BufReader<File>>, e: &BytesStart) -> Result<u32, ParseError>
{
	let mut w = 0;
